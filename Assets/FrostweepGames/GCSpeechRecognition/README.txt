...
VERSION 4.2.1 - IMPROVEMENTS OF MICROPHONE CORE USAGE
VERSION 4.2.2 - MEMORY LEAK FIXES OF NETWORK
VERSION 4.3 - UPGRADE OF SUPPORT FOR MICROPHONE PRO. UPDATED API. FIXED ERRORS WITH LONG RUNNING API
